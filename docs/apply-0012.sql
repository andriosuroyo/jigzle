-- apply-0012.sql
-- Paste-ready bundle for the Supabase SQL editor. Adds the Sales order-entry schema
-- (J2.1): order_lines.unit_price_idr (D4), the 'Partial' payment_status (D5), and the
-- create_order() write function. SQL is identical to
-- supabase/migrations/0012_sales_order_entry.sql; only this banner is added. Additive —
-- it does not touch existing rows, the stock_check view, or the importer. Run it once.

-- ============================================================================
-- 0012_sales_order_entry.sql
-- ============================================================================
